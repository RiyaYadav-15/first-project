...
export const DirectorySection: React.FC = () => {
  ...
  return (
    <section id="directory-section" className="py-10 px-4 sm:px-6 lg:px-8 bg-[#1a1816]">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 pb-4 border-b border-[#383430]">
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-4 py-2 rounded-md bg-[#8d7d70] text-[#141414] text-xs font-bold uppercase tracking-wider hover:bg-[#a1958b] transition-colors shadow-2xs flex items-center gap-2 cursor-pointer border border-[#a1958b]"
            >
            ...
            {/* View toggle */}
            <div className="flex items-center bg-[#242220] border border-[#383430] rounded-md p-0.5">
              <button
                onClick={() => setViewMode('grid')}
                className={`p-1.5 rounded text-xs transition-colors cursor-pointer ${
                  viewMode === 'grid' ? 'bg-[#2d2a27] text-[#c99c7b] shadow-xs' : 'text-[#a1958b] hover:text-[#f5f2ed]'
                }`}
                title="Grid View"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded text-xs transition-colors cursor-pointer ${
                  viewMode === 'table' ? 'bg-[#2d2a27] text-[#c99c7b] shadow-xs' : 'text-[#a1958b] hover:text-[#f5f2ed]'
                }`}
                title="Table View"
              >
        ...
        {/* Filter Controls Bar */}
        <div className="bg-[#201e1c] rounded-xl border border-[#383430] p-4 shadow-md mb-6 space-y-3.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
            ...
            <div className="md:col-span-4">
              <select
                ...
                className="w-full px-2.5 py-2 text-xs bg-[#1a1816] border border-[#383430] rounded-md text-[#f5f2ed] focus:outline-none focus:border-[#8d7d70] cursor-pointer"
              >
            ...
            <div className="md:col-span-3">
              ...
              >
                {BATCH_RANGES.map((b) => (
                  <option key={b.label} value={b.label} className="bg-[#242220]">
                    {b.label}
                  </option>
                ))}
              </select>
          ...
          <div className="pt-2 border-t border-[#383430]/70">
            <div className="flex items-center justify-between text-[11px] text-[#a1958b] mb-1.5 px-0.5">
              <span className="font-bold uppercase tracking-wider text-[#c99c7b] flex items-center gap-1.5">
                <School className="w-3.5 h-3.5 text-[#c99c7b]" />
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-xs font-semibold whitespace-nowrap transition-colors cursor-pointer shrink-0 border ${
                      isActive
                        ...
                        : 'bg-[#242220] text-[#d6cfc7] border-[#383430] hover:bg-[#2d2a27] hover:text-white'
                    }`}
                  >
                    {chip.label}
                  </button>
          ...
          <div className="pt-1.5">
            <div className="flex items-center justify-between text-[11px] text-[#a1958b] mb-1.5 px-0.5">
              <span className="font-bold uppercase tracking-wider text-[#c99c7b] flex items-center gap-1.5">
                <Briefcase className="w-3.5 h-3.5 text-[#c99c7b]" />
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-xs font-semibold whitespace-nowrap transition-colors cursor-pointer shrink-0 border ${
                      isActive
                        ...
                        : 'bg-[#1c1a18] text-[#a1958b] border-[#383430] hover:bg-[#242220] hover:text-[#f5f2ed]'
                    }`}
                  >
                    {chip.label}
                  </button>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-[#383430] text-xs">
            <div className="flex flex-wrap items-center gap-3">
              
              <div className="flex items-center gap-1.5">
                <span className="text-[11px] font-bold text-[#c99c7b] uppercase tracking-wider">
                  Industry:
                </span>
                <select
                  id="filter-industry"
                  ...
                  className="px-2 py-1 bg-[#1a1816] border border-[#383430] rounded text-xs text-[#f5f2ed] focus:outline-none cursor-pointer"
                >
                  <option value="All" className="bg-[#242220]">All Sectors</option>
                  <option value="Technology" className="bg-[#242220]">Technology & AI</option>
                  ...
                  <option value="Legal Services" className="bg-[#242220]">Legal & Law</option>
                  <option value="Startups & Venture Capital" className="bg-[#242220]">Startups</option>
                </select>
              </div>

              {/* Mentors toggle */}
              <label className="flex items-center gap-1.5 cursor-pointer select-none text-[#d6cfc7] font-medium">
                <input
                  type="checkbox"
                  checked={onlyMentors}
                  onChange={(e) => setOnlyMentors(e.target.checked)}
                  className="w-3.5 h-3.5 accent-[#8d7d70] rounded"
                />
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-semibold text-[#a1958b]">
                Showing <strong className="text-[#f5f2ed]">{filteredAlumni.length}</strong> of {alumniList.length} alumni
              </span>

              {(globalSearchQuery || selectedSchool !== 'All' || selectedBatchRange !== 'All Batches' || selectedIndustry !== 'All' || onlyMentors || onlySaved) && (
                <button
                  onClick={resetAllFilters}
                  className="text-xs text-[#c99c7b] hover:text-[#f5f2ed] flex items-center gap-1 cursor-pointer font-medium"
                >
        ...
        {filteredAlumni.length === 0 ? (
          <div className="bg-[#242220] rounded-xl border border-[#383430] p-12 text-center max-w-lg mx-auto my-8">
            <GraduationCap className="w-12 h-12 text-[#c99c7b] mx-auto mb-3" />
            <h3 className="font-locania text-xl font-bold text-[#f5f2ed] mb-2">
              No alumni match the specified criteria
            </h3>
            <p className="text-xs text-[#a1958b] mb-6">
              Try adjusting your search terms, changing the school or batch filter, or add an alumnus to the directory.
            </p>
            <div className="flex justify-center gap-3">
              <button
                onClick={resetAllFilters}
                className="px-4 py-2 rounded-md bg-[#2d2a27] text-[#f5f2ed] text-xs font-semibold hover:bg-[#383430] border border-[#3e3833] transition-colors cursor-pointer"
              >
                Reset Filters
              </button>
              <button
                onClick={() => setIsAddAlumniModalOpen(true)}
                className="px-4 py-2 rounded-md bg-[#8d7d70] text-[#141414] text-xs font-bold hover:bg-[#a1958b] transition-colors cursor-pointer"
              >
                Add This Alumnus
              </button>
            </div>
            ...
            {filteredAlumni.map((alumnus) => {
              ...
              return (
                <div
                  ...
                  className="bg-[#242220] rounded-xl border border-[#383430] hover:border-[#504842] p-5 shadow-md hover:shadow-xl transition-all flex flex-col justify-between group"
                >
                  <div>
                    ...
                    <div className="flex items-start justify-between gap-3 mb-4">
                      <div className="relative">
                        <img
                          ...
                          className="w-14 h-14 rounded-full object-cover border border-[#8d7d70] bg-[#1a1816]"
                        />
                        {alumnus.verified && (
                          <span 
                            title="Verified GBU Alumnus"
                            className="absolute -bottom-1 -right-1 p-0.5 rounded-full bg-[#2d2a27] text-[#c99c7b] border-2 border-[#242220]"
                          >
                      ...
                      <div className="flex flex-col items-end gap-1.5">
                        ...
                        {alumnus.isAvailableForMentoring && (
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-emerald-950/70 text-emerald-300 border border-emerald-800 flex items-center gap-1">
                    ...
                    <div className="mb-3">
                      <h4 
                        ...
                        className="font-locania text-lg font-bold text-[#f5f2ed] hover:text-[#c99c7b] cursor-pointer transition-colors"
                      >
                        {alumnus.fullName}
                      </h4>
                      <p className="text-xs font-semibold text-[#c99c7b] truncate mt-0.5">
                        {alumnus.currentRole}
                      </p>
                      <p className="text-xs text-[#a1958b] font-medium truncate flex items-center gap-1 mt-0.5">
                    ...
                    {/* Academic info */}
                    <div className="bg-[#1c1a18] p-2.5 rounded-lg border border-[#383430] text-[11px] text-[#a1958b] space-y-1 mb-3.5">
                      <div className="flex items-center justify-between text-[#8d7d70]">
                        <span className="font-semibold text-[#f5f2ed]">{alumnus.degree}</span>
                        <span>Batch {alumnus.batchYear}</span>
                      </div>
                      <p className="text-[10.5px] text-[#a1958b] truncate">
                        {alumnus.school}
                      </p>
                      <div className="flex items-center gap-1 text-[10.5px] text-[#8d7d70] pt-0.5">
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {alumnus.skills.slice(0, 3).map((skill, i) => (
                        <span
                          key={i}
                          className="px-2 py-0.5 rounded text-[10.5px] bg-[#2d2a27] text-[#d6cfc7] border border-[#3e3833] font-medium"
                        >
                          {skill}
                        </span>
                      ))}
                      {alumnus.skills.length > 3 && (
                        <span className="px-1.5 py-0.5 rounded text-[10px] text-[#8d7d70] bg-[#1c1a18] border border-[#383430]">
                          +{alumnus.skills.length - 3}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="pt-3 border-t border-[#383430] grid grid-cols-2 gap-2">
                    ...
                    {alumnus.isAvailableForMentoring ? (
                      <button
                        ...
                        className="py-1.5 px-3 rounded-md text-xs font-bold text-[#141414] bg-[#8d7d70] hover:bg-[#a1958b] transition-colors cursor-pointer text-center flex items-center justify-center gap-1"
                      >
                      ...
                      <button
                        ...
                        className={`py-1.5 px-3 rounded-md text-xs font-semibold transition-colors cursor-pointer text-center ${
                          isConnected
                            ...
                            : 'bg-[#2d2a27] border border-[#48423c] text-[#f5f2ed] hover:bg-[#383430]'
                        }`}
                      >
          ...
          /* TABLE VIEW */
          <div className="bg-[#242220] rounded-xl border border-[#383430] overflow-x-auto shadow-md">
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-[#1c1a18] border-b border-[#383430] text-[11px] font-bold text-[#c99c7b] uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-[#383430]">
                {filteredAlumni.map((alumnus) => (
                  <tr key={alumnus.id} className="hover:bg-[#2d2a27]/50 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2.5">
                        <img
                          src={alumnus.avatarUrl}
                          alt={alumnus.fullName}
                          className="w-8 h-8 rounded-full object-cover border border-[#8d7d70]"
                        />
                        <div>
                          <p 
                            onClick={() => setSelectedAlumniForDetail(alumnus)}
                            className="font-bold text-[#f5f2ed] hover:text-[#c99c7b] cursor-pointer"
                          >
                            {alumnus.fullName}
                          </p>
                          <p className="text-[10px] text-[#78716c] font-mono">{alumnus.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-4">
                      <p className="font-semibold text-[#c99c7b]">{alumnus.currentRole}</p>
                      <p className="text-[#a1958b] text-[11px]">{alumnus.currentCompany}</p>
                    </td>
                    <td className="py-3 px-4">
                      <p className="font-medium text-[#f5f2ed] truncate max-w-xs">{alumnus.degree}</p>
                      <p className="text-[10px] text-[#78716c] truncate max-w-xs">{alumnus.school.split('(')[1]?.replace(')', '') || alumnus.school}</p>
                    </td>
                    <td className="py-3 px-4 font-semibold text-[#c99c7b]">
                      {alumnus.batchYear}
                    </td>
                    <td className="py-3 px-4 text-[#a1958b]">
                      {alumnus.location}
                    </td>
                    <td className="py-3 px-4">
                      {alumnus.isAvailableForMentoring ? (
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-950/70 text-emerald-300 border border-emerald-800">
                          Mentor
                        </span>
                      ) : (
                        <span className="px-2 py-0.5 rounded text-[10px] font-medium bg-[#2d2a27] text-[#a1958b] border border-[#383430]">
                          Alumni
                        </span>
                      )}
                    </td>
                    <td className="py-3 px-4 text-right">
                      <button
                        onClick={() => setSelectedAlumniForDetail(alumnus)}
                        className="px-2.5 py-1 text-xs font-semibold rounded bg-[#2d2a27] border border-[#423c37] text-[#f5f2ed] hover:bg-[#383430] cursor-pointer"
                      >
                        View
                      </button>
                    </td>
